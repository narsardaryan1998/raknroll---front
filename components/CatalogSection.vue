<template>
  <section id="catalogSection" class="margin-top-6vh">
    ...
    <div class="catalogSection_articles cursor-pointer margin-top-6vh">
      <v-hover
        v-slot="{ hover }">
        <div class="content-height catalogSection_beer inset-shadow-from-top"
             data-aos="fade-up"
             data-aos-delay="460"
             data-aos-duration="1000">
      ...
      <v-hover
        v-slot="{ hover }">
        <div class="content-height catalogSection_snacks inset-shadow-from-top"
             data-aos="fade-up"
             data-aos-delay="950"
             data-aos-duration="1000">
      ...
      <v-hover
        v-slot="{ hover }">
        <div class="content-height catalogSection_crayfish inset-shadow-from-top"
             data-aos="fade-up"
             data-aos-delay="200"
             data-aos-duration="1000">
      ...
      <v-hover
        v-slot="{ hover }">
        <div class="content-height catalogSection_dried-fish inset-shadow-from-top"
             data-aos="fade-up"
             data-aos-delay="1100"
             data-aos-duration="1000">
          <NuxtLink :to='localePath("/products/zakuski/rybnye/all-brands/page-1")'>
            <v-img
              :class="hover ? ' scale-1-2' : ''"
      ...
      <v-hover
        v-slot="{ hover }">
        <div class="content-height catalogSection_alcohol inset-shadow-from-bottom"
             data-aos="fade-up"
             data-aos-delay="400"
             data-aos-duration="1000">
          <NuxtLink :to='localePath("/products/napitki-2/vino-2/all-brands/page-1")'>
            <v-img
              :class="hover ? ' scale-1-2' : ''"
      ...
      <v-hover
        v-slot="{ hover }">
        <div class="content-height catalogSection_rolls inset-shadow-from-bottom"
             data-aos="fade-up"
             data-aos-delay="100"
             data-aos-duration="1000">
      ...
      <v-hover
        v-slot="{ hover }">
        <div class="content-height catalogSection_drinks inset-shadow-from-bottom"
             data-aos="fade-up"
             data-aos-delay="800"
             data-aos-duration="1000">
          <NuxtLink :to='localePath("/products/napitki-2/all-subcategories/all-brands/page-1")'>
            <v-img
              :class="hover ? ' scale-1-2' : ''"
      ...
      <v-hover
        v-slot="{ hover }">
        <div class="content-height catalogSection_cider inset-shadow-from-bottom"
             data-aos="fade-up"
             data-aos-delay="300"
             data-aos-duration="1000">
          <NuxtLink :to='localePath("/products/razlivnye-napitki/sidr-2/all-brands/page-1")'>
            <v-img
              :class="hover ? ' scale-1-2' : ''"
...
<style scoped>
.catalogSection_articles{width:100%;height:600px;position:relative}#catalogSection .content-height{overflow:hidden;position:absolute;height:300px}#catalogSection .catalogSection_beer{top:0;left:0;width:25%}#catalogSection .catalogSection_snacks{top:0;left:25%;width:20%}#catalogSection .catalogSection_crayfish{top:0;left:45%;width:33%}#catalogSection .catalogSection_dried-fish{top:0;left:78%;width:22%}#catalogSection .catalogSection_alcohol{top:300px;left:0;width:22%}#catalogSection .catalogSection_rolls{top:300px;left:22%;width:36%}#catalogSection .catalogSection_drinks{top:300px;left:58%;width:23%}#catalogSection .catalogSection_cider{top:300px;left:81%;width:19%}.catalogSection_articles_hover{background-color:rgba(0,0,0,.7);opacity:0;transition:.5s;display:table-cell;text-align:center;vertical-align:middle}.catalogSection_articles_hover_header{font-size:32px}
</style>
