<template>
    <div class="first-intro">
      <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
           xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1145.7 288.31">
        <defs>
          <style>.cls-1, .cls-2 {
            fill: none;
          }
          ...
          <pattern id="_10_lpi_60_2" data-name="10 lpi 60% 2" x="-66.36" y="-94.35" width="72" height="72"
                   patternUnits="userSpaceOnUse" viewBox="0 0 72 72">
          ...
          <pattern id="_10_lpi_60_2-3" data-name="10 lpi 60% 2" width="72" height="72" patternUnits="userSpaceOnUse"
                   viewBox="0 0 72 72">
            <rect class="cls-1" width="72" height="72"/>
            <line class="cls-2" x1="71.75" y1="68.4" x2="144.25" y2="68.4"/>
            <line class="cls-2" x1="71.75" y1="54" x2="144.25" y2="54"/>
        ...
        <g id="Black">
          <path class="cls-3" d="M138.3,321.47V100.16H138V376.84h44.05V321.47Z" transform="translate(-66.36 -94.35)"/>
          <path class="cls-3"
          ...
          <path class="cls-3"
                ...
                transform="translate(-66.36 -94.35)"/>
          <path class="cls-3" d="M756.61,270.89v106h71.95V198.94Z" transform="translate(-66.36 -94.35)"/>
          <path class="cls-3" d="M958,100.16V376.84h60.09V100.16Z" transform="translate(-66.36 -94.35)"/>
          <path class="cls-3"
        ...
        <g id="Lines">
          ...
          <path class="cls-5"
                ...
                transform="translate(-66.36 -94.35)"/>
          <path class="cls-5" d="M460,166.93q-10.38,75.58-13.1,111.14H460v49H447.81l-4.32,49.73H369.1l36.7-276.68H460Z"
                transform="translate(-66.36 -94.35)"/>
          <path class="cls-5"
                d="M635.11,147.5v182A46,46,0,0,0,646,328.42v48.42H563.16V100.16H617q16.11,0,29,.46v47.67A61.24,61.24,0,0,0,635.11,147.5Z"
                transform="translate(-66.36 -94.35)"/>
          <polygon class="cls-4" points="762.2 5.81 762.2 104.59 690.25 176.54 690.25 5.81 762.2 5.81"/>
          <polygon class="cls-4"
